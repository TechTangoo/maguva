  ...
  return (
    <div id='about' className="flex min-h-screen flex-row items-center justify-between p-12 md:p-24 bg-gray-100">
      <div className='flex flex-col max-w-lg'>
        <h2 className='font-palanquin text-4xl font-bold text-gray-800 mb-4 lg:max-w-lg'>Welcome to Maguva</h2>
        <p className='text-orange-600 text-xl font-bold mb-6'>Where Health Meets Taste</p>
        ...
        <p className='text-gray-600 leading-7 mt-4'>
          <span className='font-bold'>Our Promise:</span> We are more than just a brand; we are a community that shares a love for good food and a commitment to well-being. 
