...
export default function App() {
    ...
    return (
        <main className="bg-opacity-10" style={{  backgroundRepeat: 'repeat', backgroundSize: 'contain', backgroundAttachment:'fixed' }}>
            <div className="fixed z-50 w-screen h-14 flex justify-center mt-5">
                <div className='bg-amber-100 flex items-center lg:w-1/2 md:w-3/4 sm:w-3/4 lg:h-14 md:h-14 sm:h-14 rounded-full shadow-md'>
